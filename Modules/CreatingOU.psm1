...
if ($OU_Confirm -eq 1) {
   New-ADOrganizationalUnit -Name $OU_Name -City $OU_City -Country $OU_Country -DisplayName $OU_Country -PostalCode $OU_Zip -State $OU_State -path (OU=$OU_Name DC=$Domainname DC=com)
   Choose_Par
